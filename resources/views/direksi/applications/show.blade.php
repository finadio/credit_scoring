    ...
    <div class="py-4">
        <div class="container">
            <div class="card shadow-sm">
                <div class="card-body">
                    <a href="{{ route('direksi.applications.index') }}" class="btn btn-secondary mb-4">
                    ...
                    {{-- Aksi Direksi: Setujui atau Tolak --}}
                    @if ($creditApplication->application_status === 'on_review')
                        <div class="mt-4 d-flex gap-3">
                            <form action="{{ route('direksi.applications.approve', $creditApplication->id) }}" method="POST">
                                @csrf
                                @method('PUT')
    ...
    <div class="modal fade" id="reject-application-modal" tabindex="-1" aria-labelledby="rejectApplicationModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="post" action="{{ route('direksi.applications.reject', $creditApplication->id) }}" class="p-4">
                    @csrf
                    @method('PUT')
