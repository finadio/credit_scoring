                            ...
                            <tbody>
                                @forelse ($applications as $application)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('kabag.applications.show', $application->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">Belum ada pengajuan kredit yang perlu direview.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
